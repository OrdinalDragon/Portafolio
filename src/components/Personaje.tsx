        ...
        <div className="w-full max-w-sm sm:max-w-md bg-surface-container-lowest border-l-4 border-primary p-4 sm:p-5 md:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.7)] text-left relative overflow-hidden mx-auto">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start mb-3 sm:mb-4 text-center sm:text-left">
            ...
            <div className="flex-1 w-full overflow-hidden">
              <h3 className="font-headline text-sm sm:text-2xl text-on-surface mb-1 uppercase tracking-wider break-words">{t('personaje.name')}</h3>
              <p className="font-label text-primary text-[8px] sm:text-xs uppercase tracking-[0.05em] sm:tracking-widest mb-2 sm:mb-3">{t('personaje.role')}</p>
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="h-2 sm:h-3 bg-surface-container-highest border border-outline-variant/15 p-0.5">
          ...
          <div className="mt-4 sm:mt-6 grid grid-cols-3 gap-2">
            <div className="text-center p-1.5 sm:p-3 bg-surface-container-low border border-outline-variant/10">
