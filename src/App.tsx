    ...
    <>
      ...
      <aside className={`fixed left-0 top-0 h-full w-64 bg-surface-container-lowest border-r border-outline-variant/15 flex flex-col pt-8 z-[70] transition-transform duration-300 lg:translate-x-0 lg:top-20 lg:h-[calc(100vh-5rem)] ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="lg:hidden absolute top-4 right-4">
          <button onClick={onClose} className="text-on-surface/60 hover:text-primary cursor-pointer">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="px-6 mb-10 flex flex-col items-center">
          ...
          <h3 className="font-headline text-on-surface font-bold text-lg text-center">FullStack Hero</h3>
          <p className="font-label text-on-surface-variant text-xs uppercase tracking-widest">Level 30 Architect</p>
        </div>

        <nav className="flex-1 px-4 space-y-2 font-label overflow-y-auto">
          {navItems.map((item) => (
            <button
              key={item.id}
              onClick={() => {
...
const TopNav = ({ activeScreen, setScreen, onMenuClick }: { activeScreen: Screen, setScreen: (s: Screen) => void, onMenuClick: () => void }) => {
  return (
    <nav className="fixed top-0 w-full flex justify-between items-center px-2 sm:px-4 md:px-8 h-16 sm:h-20 bg-surface-container-lowest z-50 border-b border-outline-variant/15 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.7)]">
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="font-headline font-black text-primary-container drop-shadow-[0_2px_4px_rgba(255,145,0,0.5)] text-[10px] sm:text-lg md:text-2xl tracking-tighter cursor-pointer leading-tight" onClick={() => setScreen('personaje')}>
          ORDINAL <br className="sm:hidden" /> DRAGON_STACK
        </div>
      </div>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="mb-10 md:mb-20 text-center lg:text-left relative px-4">
        <p className="font-label text-primary-container text-[10px] sm:text-sm font-bold tracking-[0.1em] sm:tracking-[0.3em] uppercase mb-2">Compendio de Sabiduría</p>
        <h1 className="font-headline text-2xl sm:text-5xl md:text-7xl font-black text-on-surface leading-none mb-6 uppercase break-words text-center lg:text-left">BESTIARIO TÉCNICO</h1>
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="mb-12 md:mb-16 px-4 text-center md:text-left">
        <div className="flex items-center justify-center md:justify-start gap-4 mb-2">
          ...
          <span className="font-label text-[10px] sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.4em] text-on-surface-variant">Viajes en curso</span>
        </div>
        ...
        <div className="lg:col-span-8 bg-surface-container-highest parchment-glow border-l-8 border-primary relative overflow-hidden group">
          <div className="p-6 md:p-12">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              <div>
                <span className="font-label text-[9px] uppercase tracking-widest text-primary bg-on-primary-fixed-variant/20 px-3 py-1 mb-3 inline-block">ENTRENAMIENTO DE ÉLITE</span>
                <h2 className="font-headline text-2xl md:text-3xl font-bold text-on-surface break-words">Misión: Programación Full-Stack</h2>
                <p className="font-label text-xs text-on-surface-variant">(Fundación Pescar / Banco Nación)</p>
              </div>
              <div className="flex flex-col items-start md:items-end">
                <span className="font-headline text-xl md:text-2xl font-black text-primary">+1500 XP</span>
                <span className="font-label text-[9px] uppercase text-on-surface-variant">En Formación</span>
              </div>
            </div>
            <div className="mb-10">
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 flex flex-col items-center">
      <header className="text-center mb-10 md:mb-16 max-w-2xl px-4">
        <span className="text-secondary font-label text-[10px] sm:text-xs uppercase tracking-[0.1em] sm:tracking-[0.3em] block mb-2">Los Registros del Cronista</span>
        <h1 className="text-2xl sm:text-5xl md:text-7xl font-headline font-bold text-on-surface tracking-tight leading-none mb-6 uppercase break-words text-center">EL ASCENSO DEL ARCHIMAGO</h1>
        <div className="h-1 w-16 md:w-24 bg-primary mx-auto mb-6"></div>
        <p className="text-on-surface-variant font-body text-sm md:text-lg italic opacity-80">"De la alquimia de los electrones al dominio absoluto del tejido digital."</p>
      </header>
      ...
      <div className="relative w-full max-w-6xl lg:aspect-[16/10] bg-surface-container-high rounded-sm shadow-[0_30px_100px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col lg:flex-row border border-outline-variant/20">
          ...
          <div className="mt-8 flex justify-center">
            <div className="relative group cursor-pointer">
              ...
              <div className="w-12 h-12 md:w-16 md:h-16 bg-error-container rounded-full flex items-center justify-center shadow-inner border border-error/30 relative">
                <Zap className="text-on-error" size={24} md:size={32} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 bg-surface-container-low p-6 md:p-12 lg:p-20 relative overflow-y-auto scrollbar-hide">
          ...
          <h2 className="font-headline text-2xl md:text-3xl text-secondary mb-6 border-b border-outline-variant/20 pb-4 break-words">Capítulo II: La Forja del Archimago</h2>
          <div className="space-y-4 text-on-surface-variant leading-relaxed text-base md:text-lg font-body">
          ...
          <div className="absolute bottom-6 right-6 rotate-12 opacity-40 hover:opacity-100 transition-opacity">
            <Terminal className="text-primary" size={40} md:size={60} />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 min-h-screen">
      <header className="mb-10 md:mb-16 flex flex-col md:flex-row justify-between items-center md:items-end gap-6 md:gap-8 px-4">
        <div className="text-center md:text-left">
          <span className="font-label text-[10px] sm:text-sm uppercase tracking-[0.1em] sm:tracking-[0.3em] text-primary block mb-2">Senda de Maestría Técnica</span>
          <h1 className="font-headline text-xl sm:text-4xl md:text-6xl font-bold tracking-tight text-on-surface break-words">Árbol de Habilidades</h1>
        </div>
        <div className="bg-surface-container-high p-3 md:p-4 border border-outline-variant/20 flex gap-6 md:gap-8 w-full md:w-auto justify-center md:justify-start">
          <div className="text-center">
            <p className="font-label text-[9px] md:text-[10px] uppercase text-on-surface-variant">Puntos Disponibles</p>
            <p className="font-headline text-xl md:text-2xl text-primary">∞</p>
          </div>
          <div className="text-center">
            <p className="font-label text-[9px] md:text-[10px] uppercase text-on-surface-variant">Nivel de Clase</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12">
        ...
        <div className="lg:col-span-1 space-y-6 md:space-y-8">
          <section className="bg-surface-container-low p-4 sm:p-6 border border-outline-variant/10 relative overflow-hidden">
            ...
            <h3 className="font-headline text-base md:text-xl font-bold mb-4 md:mb-6 uppercase tracking-widest border-b border-outline-variant/20 pb-2 text-center md:text-left">Atributos</h3>
          ...
          <section className="bg-primary/5 p-5 md:p-6 border border-primary/20">
            <h4 className="font-headline text-xs md:text-sm font-bold text-primary mb-2 uppercase">Bonus de Clase: Archimago</h4>
                  ...
                  {path.skills.map((skill, index) => (
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <skill.icon className={path.color} size={24} md:size={32} />
                      </div>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 dragon-texture min-h-screen flex flex-col items-center justify-center text-center py-6 sm:py-10 overflow-x-hidden w-full">
      <div className="max-w-4xl w-full px-4 sm:px-6 flex flex-col items-center">
        <span className="font-label text-primary uppercase tracking-[0.1em] sm:tracking-[0.4em] mb-3 md:mb-6 block text-[10px] sm:text-sm">Búsqueda del Aspirante Fullstack</span>
        <h1 className="font-headline text-2xl sm:text-5xl md:text-8xl font-bold text-on-background mb-6 md:mb-12 drop-shadow-2xl leading-tight uppercase break-words px-2 max-w-full">
          EL DESPERTAR <br className="sm:hidden" /> DEL <br className="hidden sm:block" /> <span className="text-primary-container">PROGRAMADOR</span>
        </h1>
        ...
        <div className="w-full max-w-md bg-surface-container-lowest border-l-4 border-primary p-5 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.7)] text-left relative overflow-hidden mx-auto">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center sm:items-start mb-6 md:mb-8 text-center sm:text-left">
            ...
            <div className="flex-1 w-full overflow-hidden">
              <h3 className="font-headline text-base sm:text-2xl text-on-surface mb-1 uppercase tracking-wider break-words">NICOLÁS SCHERNETZKI</h3>
              <p className="font-label text-primary text-[8px] sm:text-xs uppercase tracking-[0.05em] sm:tracking-widest mb-3">Maestro de los Reinos Fullstack</p>
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <div className="flex justify-between items-end">
                <span className="font-mono text-[10px] sm:text-xs text-on-surface-variant uppercase flex items-center gap-1.5">
                  <Flame size={12} className="text-primary" /> VITALIDAD
                </span>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-end">
                <span className="font-mono text-[10px] sm:text-xs text-on-surface-variant uppercase flex items-center gap-1.5">
                  <Zap size={12} className="text-secondary" /> MANÁ
                </span>
          ...
          <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
            <div className="text-center p-2 sm:p-3 bg-surface-container-low border border-outline-variant/10 flex sm:flex-col items-center sm:justify-center justify-between px-3 sm:px-2">
              <p className="font-label text-[8px] sm:text-[10px] text-on-surface-variant uppercase mb-0 sm:mb-1">Fuerza</p>
              <p className="font-headline text-xs sm:text-lg text-primary">22</p>
            </div>
            <div className="text-center p-2 sm:p-3 bg-surface-container-low border border-outline-variant/10 flex sm:flex-col items-center sm:justify-center justify-between px-3 sm:px-2">
              <p className="font-label text-[8px] sm:text-[10px] text-on-surface-variant uppercase mb-0 sm:mb-1">Agilidad</p>
              <p className="font-headline text-xs sm:text-lg text-primary">20</p>
            </div>
            <div className="text-center p-2 sm:p-3 bg-surface-container-low border border-outline-variant/10 flex sm:flex-col items-center sm:justify-center justify-between px-3 sm:px-2">
              <p className="font-label text-[8px] sm:text-[10px] text-on-surface-variant uppercase mb-0 sm:mb-1">Intelecto</p>
        ...
        <div className="mt-10 sm:mt-16">
          ...
          >
            <span className="relative z-10 uppercase">Comenzar</span>
...
const Contacto = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Ensure we only use Formspree if a valid ID is provided and not the string "undefined"
    const isFormspreeValid = rawFormspreeId && rawFormspreeId !== 'undefined' && rawFormspreeId.trim() !== '';
    
    let endpoint = '/api/contact';
    if (isFormspreeValid) {
      // Extract ID if user accidentally provided the full URL
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-2xl mx-auto px-4 md:px-0">
      <header className="mb-10 md:mb-12 text-center px-2">
        <span className="font-label text-primary uppercase tracking-[0.3em] mb-2 block text-[10px] md:text-xs">Canal de Comunicación</span>
        <h1 className="font-headline text-3xl md:text-6xl font-bold text-on-surface uppercase italic break-words">Enviar Mensaje</h1>
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 md:py-12 px-4 md:px-0">
      <header className="mb-10 md:mb-16 text-center px-4">
        <span className="font-label text-primary uppercase tracking-[0.1em] sm:tracking-[0.3em] mb-2 block text-[10px] sm:text-xs">Taller del Creador</span>
        <h1 className="font-headline text-2xl sm:text-5xl md:text-6xl font-black text-on-surface italic uppercase tracking-normal sm:tracking-widest mb-4 break-words text-center">La Forja de Artefactos</h1>
      ...
      <div className="relative bg-surface-container-lowest border-2 border-dashed border-primary/30 p-6 sm:p-12 md:p-20 flex flex-col items-center justify-center text-center overflow-hidden rounded-xl">
        {/* Decorative elements */}
        ...
        >
          <Hammer size={60} className="sm:w-[80px] sm:h-[80px] md:w-[120px] md:h-[120px]" strokeWidth={1} />
        </motion.div>

        <h3 className="font-headline text-lg sm:text-2xl md:text-3xl font-bold text-on-surface mb-4 uppercase tracking-normal sm:tracking-widest break-words">Forja en Mantenimiento</h3>
        
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="w-2 h-2 rounded-full bg-primary animate-ping"></div>
          <p className="font-label text-primary text-[10px] sm:text-xs md:text-sm uppercase tracking-widest">Martillos golpeando el yunque...</p>
        </div>

        <p className="font-body text-on-surface-variant max-w-md mb-10 text-xs sm:text-sm md:text-base leading-relaxed italic">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 w-full max-w-3xl">
          {[
            ...
            <div key={i} className="bg-surface-container-highest/50 p-4 border border-outline-variant/10 rounded-sm">
              <p className="font-label text-[9px] sm:text-[10px] text-on-surface-variant uppercase mb-1">{item.label}</p>
              <p className="font-headline text-primary font-bold text-xs sm:text-sm uppercase">{item.status}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 md:py-12 px-4 md:px-0">
      <header className="mb-10 md:mb-12 text-center px-4">
        <h2 className="font-headline text-xl sm:text-4xl md:text-5xl font-black text-primary italic uppercase tracking-normal sm:tracking-widest mb-4 break-words">Hoja de Estadísticas</h2>
        <p className="font-label text-on-surface-variant text-[9px] sm:text-xs uppercase tracking-[0.1em] sm:tracking-[0.3em]">Resumen de Atributos y Experiencia</p>
      </header>
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface selection:bg-primary-container selection:text-on-primary overflow-x-hidden">
      ...
      <div className="flex pt-20">
        <Sidebar activeScreen={screen} setScreen={setScreen} isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)} setActiveModal={setActiveModal} />
